...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/13 07:52:49 by afarheen          #+#    #+#             */
/*   Updated: 2024/03/13 15:26:21 by afarheen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_int(std::string literal)
{
	...
	if ((num >= 0 && (num/100000) < 10) || (num <= 0 && (-num/100000) < 10))
		std::cout << std::fixed << std::setprecision(1);
	f = static_cast<float>(num);
	d = static_cast<double>(num);
	if(num <= 127 && isprint((int)num))
